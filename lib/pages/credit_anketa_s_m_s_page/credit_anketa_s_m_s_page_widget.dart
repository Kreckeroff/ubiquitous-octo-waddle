...
import 'credit_anketa_s_m_s_page_model.dart';
export 'credit_anketa_s_m_s_page_model.dart';

class CreditAnketaSMSPageWidget extends StatefulWidget {
  const CreditAnketaSMSPageWidget({
    Key? key,
    this.statusProduct,
  }) : super(key: key);
  ...
  @override
  _CreditAnketaSMSPageWidgetState createState() =>
      _CreditAnketaSMSPageWidgetState();
}

class _CreditAnketaSMSPageWidgetState extends State<CreditAnketaSMSPageWidget> {
  late CreditAnketaSMSPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreditAnketaSMSPageModel());
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: FFButtonWidget(
                          ...
                          text: 'Отправить анкету на согласование',
                          options: FFButtonOptions(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 16.0, 16.0, 16.0),
                            iconPadding: EdgeInsetsDirectional.fromSTEB(
